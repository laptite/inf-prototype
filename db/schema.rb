...
ActiveRecord::Schema.define(version: 2020_03_27_220607) do
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["collectible_type", "collectible_id"], name: "index_collections_on_collectible_type_and_collectible_id"
  ...
  create_table "post_contributors", force: :cascade do |t|
    t.integer "post_id"
